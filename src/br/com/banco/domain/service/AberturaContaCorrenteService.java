...
public class AberturaContaCorrenteService {
	...
	public static void execute() {
		...
		System.out.println("#                                       #");
		System.out.println("#                                       #");
		System.out.println("#  CADASTRO ABERTURA DE CONTA CORRENTE  #");
		System.out.println("#                                       #");
		System.out.println("#                                       #");
		System.out.println("#########################################\n");
		...
		Conta contaAberta = banco.abrirContaCorrente(cliente, senha);
